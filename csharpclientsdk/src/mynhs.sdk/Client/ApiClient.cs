...
namespace mynhs.sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = mynhs.sdk.Client.Configuration.Default;
            RestClient = new RestClient("https://virtserver.swaggerhub.com/NHSX/MyNhs/0.1");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://virtserver.swaggerhub.com/NHSX/MyNhs/0.1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? mynhs.sdk.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://virtserver.swaggerhub.com/NHSX/MyNhs/0.1")
        {
