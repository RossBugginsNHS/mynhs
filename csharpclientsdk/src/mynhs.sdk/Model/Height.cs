...
namespace mynhs.sdk.Model
{
        ...
        public partial class Height :  IEquatable<Height>
    {
        ...
        /// </summary>
        [DataMember(Name="Millimeters", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as Height);
        }

        /// <summary>
        /// Returns true if Height instances are equal
        /// </summary>
        /// <param name="input">Instance of Height to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Height input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Millimeters == input.Millimeters ||
                    (this.Millimeters != null &&
                    this.Millimeters.Equals(input.Millimeters))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Millimeters != null)
                    hashCode = hashCode * 59 + this.Millimeters.GetHashCode();
                return hashCode;
            }
        }
    }
