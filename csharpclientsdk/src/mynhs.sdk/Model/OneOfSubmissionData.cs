...
namespace mynhs.sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfSubmissionData :  IEquatable<OneOfSubmissionData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfSubmissionData" /> class.
        /// </summary>
        public OneOfSubmissionData()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfSubmissionData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfSubmissionData);
        }

        /// <summary>
        /// Returns true if OneOfSubmissionData instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfSubmissionData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfSubmissionData input)
        {
            if (input == null)
                return false;
