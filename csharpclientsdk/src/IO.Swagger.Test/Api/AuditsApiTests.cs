...
namespace IO.Swagger.Test
{
    ...
    public class AuditsApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' AuditsApi
            //Assert.IsInstanceOfType(typeof(AuditsApi), instance, "instance is a AuditsApi");
        }

        /// <summary>
        /// Test MynhsMyAuditsGet
        /// </summary>
        [Test]
        public void MynhsMyAuditsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.MynhsMyAuditsGet();
