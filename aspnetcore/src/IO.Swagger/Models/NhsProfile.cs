...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((NhsProfile)obj);
        }

        /// <summary>
        /// Returns true if NhsProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of NhsProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NhsProfile other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (NhsNumber != null)
                    hashCode = hashCode * 59 + NhsNumber.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(NhsProfile left, NhsProfile right)
        {
