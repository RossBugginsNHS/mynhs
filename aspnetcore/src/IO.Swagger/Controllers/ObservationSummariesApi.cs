...
{ 
    ...
    /// </summary>
    [ApiController]
    public class ObservationSummariesApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        [HttpGet]
        [Route("/NHSX/MyNhs/0.1/mynhs/my/observations/summaries/bloodpressure/{queryType}/{pastDays}")]
        [ValidateModelState]
        [SwaggerOperation("MynhsMyObservationsSummariesBloodpressureQueryTypePastDaysGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(NhsProfile), description: "OK")]
        public virtual IActionResult MynhsMyObservationsSummariesBloodpressureQueryTypePastDaysGet([FromRoute][Required]string queryType, [FromRoute][Required]decimal? pastDays)
        { 
        ...
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("/NHSX/MyNhs/0.1/mynhs/my/observations/summaries")]
        [ValidateModelState]
        [SwaggerOperation("MynhsMyObservationsSummariesGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(NhsProfile), description: "OK")]
        public virtual IActionResult MynhsMyObservationsSummariesGet()
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(NhsProfile));
            string exampleJson = null;
