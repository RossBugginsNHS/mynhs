...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GpProfile)obj);
        }

        /// <summary>
        /// Returns true if GpProfile instances are equal
        /// </summary>
        /// <param name="other">Instance of GpProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GpProfile other)
        {
            ...
            return 
                (
                    GpIdCode == other.GpIdCode ||
                    GpIdCode != null &&
                    GpIdCode.Equals(other.GpIdCode)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (GpIdCode != null)
                    hashCode = hashCode * 59 + GpIdCode.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(GpProfile left, GpProfile right)
        {
