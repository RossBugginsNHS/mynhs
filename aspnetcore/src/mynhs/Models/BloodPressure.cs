...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BloodPressure)obj);
        }

        /// <summary>
        /// Returns true if BloodPressure instances are equal
        /// </summary>
        /// <param name="other">Instance of BloodPressure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BloodPressure other)
        {
            ...
            return 
                (
                    ...
                    Systolic != null &&
                    Systolic.Equals(other.Systolic)
                ) && 
                (
                    Diastolic == other.Diastolic ||
                    Diastolic != null &&
                    Diastolic.Equals(other.Diastolic)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Systolic != null)
                    hashCode = hashCode * 59 + Systolic.GetHashCode();
                    if (Diastolic != null)
                    hashCode = hashCode * 59 + Diastolic.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(BloodPressure left, BloodPressure right)
        {
